...
# ── Metric for SIMBA ──────────────────────────────────────────────────────────
#
# This is the metric SIMBA optimizes.
# Checks factual correctness — not formatting.
...
def score_extract(extract: dict, source_content: str) -> dict:
    """
    Scores the factual quality of an extraction.
    Returns score 0.0–1.0 and a list of problems.
    ...
    # 2. Maturity from allowed values
    checks += 1
    ...
    # 4. Result is N/A or contains a number
    checks += 1
    ...
    # 5. Source type from allowed values
    checks += 1
    ...
    # 6. MATURITY_EVIDENCE is not generic boilerplate
    checks += 1
